...
class ModelConfig(ChoiceRegistry):
    ...
    enable_mixed_precision_training: bool = False            # Whether to enable mixed precision training
...
class Exp_7B_DINOSigLIP_ViT_L_p14_224px_Resize_Naive(Exp_7B_One_Stage):
...
class ModelRegistry(Enum):
    ...
    EXP_DINOSIGLIP_224PX_RESIZE_NAIVE = Exp_7B_DINOSigLIP_ViT_L_p14_224px_Resize_Naive
